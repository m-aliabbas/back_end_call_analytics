...
class LogAnalytics:
    ...
    def numberData(self,bot_dict):
        ...
        try:
            df_number_data = {"file_id":self.filings,"bot_specs":bot_dict, "Caller_ID":{self.filings:numbers}, "Transcript":{self.filings:dict_trans},"states_number":{self.filings:dict_state}, "Disposition":{self.filings:dict_dis}, "AI None Separater":{self.filings:self.mergerd_dict}, "total_calls":self.total_calls, "valid_calls":self.valid_calls, "total_states": self.count_class, "call_drop": self.call_drop }
